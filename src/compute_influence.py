...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_dataset", type=str, default="open-platypus_medqa-instruction-train_merged.json", help="Train dataset filename")
...
Answer:"""
    ...
    influence_engine.IF_dict['proposed'].to_csv("proposed _scores.csv", index= False)
